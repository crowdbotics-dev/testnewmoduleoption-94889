...
## Project Structure
    ...
    ├── testnewmoduleoption_94889  # Django project configurations
...
1. Clone this repo and `cd testnewmoduleoption_94889`
...
2. Clone this repo and `cd testnewmoduleoption_94889`
